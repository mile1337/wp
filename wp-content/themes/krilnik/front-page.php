				...
				<?php while ( have_rows('dodaj_vijest') ) : the_row() ; ?>
					...
					<div class="news__thumb">
					    ...
					    <div class="news__thumb__title">
							    ...
							    <?php 
							    	if(has_category('nogomet') || has_category('uncategorized')) :?>
							    		<img class="sign" src="<?php echo esc_url( get_template_directory_uri() );?>/img/layout/football-sign.png" alt="football sign"/>
							    <?php elseif (has_category('rukomet')) :?>
					...
					<div class="schedule__thumb">
						<div class="news__schedule__schedule">
							...
							<div class="text">
								...
								<h5>Vojarna Sv.Nikola <br> LORA,Split</h5>
							</div>			        
						</div><!-- End panel title schedule -->	
					</div><!-- end chedule thumb -->
					<div class="accord">
					<?php if( have_rows('raspored_treninga_nogomet','option') ):
						$count = 0;
					    while ( have_rows('raspored_treninga_nogomet', 'option') ) : the_row();
					    	$count++; ?>
					        <div class="accordion">
